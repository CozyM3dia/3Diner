      ...
      >
        <div className="flex items-center gap-3">
          {modelPreview ? (
            ...
            <img src={modelPreview} alt="Preview model" className="w-12 h-12 rounded-lg object-cover shrink-0" style={{ background: "#0D1829" }} />
          ) : (
        ...
        >
          ...
          >
            ...
            >
              {tripoPreview ? (
                // eslint-disable-next-line @next/next/no-img-element
                <img src={tripoPreview} alt="Preview" className="max-h-36 object-contain" style={{ background: "repeating-conic-gradient(#1a2a3a 0% 25%, #0d1829 0% 50%) 0 0 / 16px 16px" }} />
              ) : (
                <>
