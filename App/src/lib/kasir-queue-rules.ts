 ...
 *  pay-at-cashier lahir dengan payment_method='cash' (lihat create_order), jadi
 *  payment_method null selalu berarti pesanan online — yang dilunasi webhook
 *  Midtrans, bukan kasir. Mengunci ke 'cash' juga menghindari salah label pada
 *  jendela sempit saat webhook sudah menaikkan status ke 'received' tapi belum
 *  sempat menulis payment_method + 'paid'. */
