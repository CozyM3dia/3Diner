...
-- Perbaikan bug: commit_order_atomic sebelumnya menghitung v_hash hanya dari p_items,
-- sedangkan issue_order_quote menyimpan request_hash atas objek lengkap (cafe_id, table_number, items, notes, channel, quote_id).
-- Akibatnya perbandingan v_quote.request_hash <> v_hash selalu gagal dan setiap checkout ditolak
-- sebagai quote_mismatch. Definisi di bawah menghitung ulang hash dengan rumus identik.
